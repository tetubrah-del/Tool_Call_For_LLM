...
const MANAGED_JOBS = [
  ...
  },
  {
    ...
    schedule: "15 */3 * * *",
    startCommand:
      "node scripts/moltbook-sinkai-agent.mjs scout --limit 20 --top 15 --min-similarity 0.35 --min-matches 2 --csv output/moltbook/sinkai-candidates-latest.csv --out output/moltbook/sinkai-candidates-latest.json"
  },
  {
